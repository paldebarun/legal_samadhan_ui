...
const TeamMemberPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    console.log("This is member : ",team)

    fetchMember();
  }, [id, team, dispatch]);

  if (loading) return <div className="col-span-full flex justify-center items-center py-20">
 ...
 <img
        ...
        alt={member.name}
        className="w-[300px] sm:w-5/12 mx-auto block md:hidden py-3"
      />
